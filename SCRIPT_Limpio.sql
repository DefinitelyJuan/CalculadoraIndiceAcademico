...
CREATE TABLE Indice(
	SubjectID char(6) PRIMARY KEY NOT NULL,
...
-- Procedimiento de guardado de asignatura
USE INTEC
Go
...
AS
BEGIN
INSERT INTO Indice (SubjectID, SubjectName, Credits, Grade) VALUES (@SubjectID, @SubjectName, @Credits, @Grade)
END;
Go

-- Procedimiento contar asignaturas
USE INTEC
Go
